package com.collabcode.apptimer.adapters
...
import com.collabcode.apptimer.AppInfo
import com.collabcode.apptimer.R

class monitorAdapter(public val context: Context,public val arrayList: ArrayList<AppInfo>):BaseAdapter() {
